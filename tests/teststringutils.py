...
class TestStringUtils(TestCase):
    ...
    def test_resizeString(self):
        ...
        # Test long string gets resized correctly to supplied length.
        self.assertEqual(30, len(StringUtils.resizeString("0123456789012345678901234567890123456789", 30)))
